                    ...
                    <table className="w-full" cellPadding={15}>
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="food" id="state" disabled={edit} onChange={(e) => setFood(e.target.value)} className="w-full p-3 text-md border border-silver rounded">
                                    {
                                        foodGroups.map((e, i) => <option value={i} selected={food === i}>{e}</option>)
                                    }
                                </select>
                            </td><td>
