...
const Bank = (props) => {
    ...
    { to: "/bank/camps", icon: "fa-clock-rotate-left", title: "Food Donation Camps" },
    { to: "/bank/registerBank", icon: "fa-rotate", title: "Register new Camp" }];
    return (
        <div className='flex w-full h-96'>
            <UserNav data={nav} />
            <div className='ml-96 w-full flex justify-center pr-24'>
                {/*: If handle is "profile", render the EditProfile component. These are features that are available on particular handles*/}
