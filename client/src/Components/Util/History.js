            ...
            <table className='rounded-md'>
                <thead>
                    {props.user == "bank" ? <tr>
                        ...
                        <th className='border p-4 px-4'>Food Group</th>
                        ...
                        <th className='border p-2'>Food Bank</th>
                ...
                <tbody>
                    {
                        data.map((e, i) =>
                            props.user == "bank" ? <tr className={status == "All" ? "" : status != e.status ? "hidden" : ""}>
                                ...
                                <td className='border p-3'>{props.handle == "donations" ? e.userId.foodGroup : e.foodGroup}</td>
                                ...
                                <td className='border p-3'>
                                    <Status status={status == "All" ? e.status : status} id={e._id} i={i} setId={setId} units={e.units} foodGroup={props.handle == "donations" ? e.userId.foodGroup : e.foodGroup} setStatus={setnewStat} handle={props.handle} />
                                </td>
